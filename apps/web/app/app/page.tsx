    ...
    <section className="product-shell">
      ...
      {view.section === "agents" && (
        <div className="product-workspace product-clientsview"><section className="product-panel product-clients">
          ...
          <div className="product-panelhead" style={{ marginTop: 18 }}><div><p className="product-eyebrow">DESKTOP AUTOMATION</p><h2>AmazFlow Desktop Agent</h2></div><a className="product-download" href="https://github.com/jaylenjefferson-star/AmazFlow/releases/latest/download/AmazFlow-Agent-0.1.0-arm64.dmg" target="_blank" rel="noreferrer">Download for macOS →</a></div>
          <div className="product-addhint">For workflow steps with the <b>desktop</b> provider — opening and driving installed Mac applications. Requires macOS 12 or later on Apple silicon. Setup: 1) open the download and drag <b>AmazFlow Agent</b> to Applications, 2) the build is not yet notarized, so macOS blocks the first launch — on macOS 15 and later, open <b>System Settings → Privacy &amp; Security</b>, find “AmazFlow Agent was blocked”, and click <b>Open Anyway</b> (the older right-click → Open shortcut no longer works), 3) sign in with your AmazFlow account, 4) grant <b>Accessibility</b> when macOS asks — the app shows exactly which permissions are missing and links straight to the right Settings pane. Screen Recording is only needed for steps that capture visual evidence. The agent keeps running from the menu bar when its window is closed. The download is hosted on the private AmazFlow repository, so it currently requires a GitHub account with access.</div>
